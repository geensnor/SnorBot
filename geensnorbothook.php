...
/*      foreach ($wikiResult[1] as $key => $value) {
      ...
      $content = array('chat_id' => $chat_id, 'text' => "Ah, je wil iets van <strong>".substr($text, 5)."</strong> weten. Dit vond ik op Wikipedia:<br><br>", 'parse_mode' => 'HTML', 'disable_web_page_preview' => TRUE);
    //}
/*    else{
