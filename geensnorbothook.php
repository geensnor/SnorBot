...
/*      foreach ($wikiResult[1] as $key => $value) {
      ...
      $content = array('chat_id' => $chat_id, 'text' => "Ah, je wil iets van <strong>".substr($text, 5)."</strong> weten. Dit vond ik op Wikipedia:<br><br><a href='http://www.nu.nl'>nu.nl</a>", 'parse_mode' => 'html', 'disable_web_page_preview' => TRUE);
    //}
/*    else{
